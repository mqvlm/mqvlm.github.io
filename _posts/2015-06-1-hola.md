...
Hace poco más de un año empecé un sitio donde quise poner algunos experimentos que hacía cuando empecé a aprender Processing. Hoy la trasteo a github, no solo para evitar los caprichos de tumblr, wordpress, y otros cms, sino para dejar más accesibles todos los códigos a través de un repositorio ordenado en [github](https://github.com/mqvlm). (Luego haré un tutorial sobre Jekyll y la trasteada).
